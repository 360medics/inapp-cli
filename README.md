...
- MacOS (darwin-amd64): 
```
curl -SL https://github.com/360medics/inapp-template/releases/download/0.0.5/inapp-0.0.5-darwin-amd64.tar.gz | tar -zxC /usr/local/bin
```

- Linux (linux-amd64): 
```
curl -SL https://github.com/360medics/inapp-template/releases/download/0.0.5/inapp-0.0.5-linux-amd64.tar.gz | tar -zxC /usr/local/bin
```
